...
<div class="main-panel">
    <div class="content-wrapper">
      <div class="page-header">
        <h3 class="page-title"> Update Club Information </h3>
      </div>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="card-description"> </p>
                    ...
                    <form enctype="multipart/form-data"  method="post" action="{{ route('clubs.update', $club->id) }}">
                        @method('PATCH')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="Enter date" placeholder="Date" value="{{ $club->date }}">
                        </div>
                        <div class="row form-group">
                            <div class="col col-md-14"><label for="Enter Zone" class=" form-control-label">Zone</label>
                                <select name="select" id="zone" class="form-control" placeholder="Zone">
                                    <option value="0">{{ $club->zone }}</option>
                        ...
                        <div class="row form-group">
                            <div class="col col-md-14"><label for="Enter category" class=" form-control-label">Category</label>
                                <select name="select" id="category" class="form-control" placeholder="Category">
                                    <option value="0">{{ $club->category }}</option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="Enter advisor" placeholder="Advisor" value="{{ $club->advisor }}">
                        </div>
